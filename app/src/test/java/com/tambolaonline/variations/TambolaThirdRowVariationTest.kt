...
public class TambolaThirdRowVariationTest {

    var tambolaThirdRowVariation = TambolaThirdRowVariation()
    ...
    fun testVariation_false() {
        ...
        assertFalse(tambolaThirdRowVariation.applyVariation(ticket,currentState))
    }
    ...
    fun testVariation_true() {
        ...
        assertTrue(tambolaThirdRowVariation.applyVariation(ticket,currentState))

    }

    @Test
    fun testVariation_ThirdRowBlank_false() {
        var ticket= arrayOf(
            arrayOf(0,0,25,37,0,0,66,78,84).toIntArray(),
            arrayOf(9,17,0,0,0,0,69,78,0).toIntArray(),
